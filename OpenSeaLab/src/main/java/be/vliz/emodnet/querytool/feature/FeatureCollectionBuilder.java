...
public class FeatureCollectionBuilder {
	...
	/**
	 * Constructs a be.vliz.emodnet.querytool.vectorLayers collection builder for the string parameter.
	 * 
	 * @param geoJSON
	...
	/**
	 * Creates a be.vliz.emodnet.querytool.vectorLayers collection from the attribute "geoJSON".
	 * 
	...
	/**
	 * Creates a be.vliz.emodnet.querytool.vectorLayers. The parameter should respect a geojson be.vliz.emodnet.querytool.vectorLayers specs.
	 * 
	 * @param feature
	 *            a map that contains be.vliz.emodnet.querytool.vectorLayers data
	 * @return {@link Feature}
	 */
	@SuppressWarnings("unchecked")
