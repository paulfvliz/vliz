...
public class PiecedCachingManager implements LayerProvider {
	 ...
	 *            be.vliz.emodnet.querytool.vectorLayers identifier (categorie)
	 * @return
	 */
