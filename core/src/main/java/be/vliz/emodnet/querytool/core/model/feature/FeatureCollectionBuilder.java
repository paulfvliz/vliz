...
public class FeatureCollectionBuilder {
	...
	/**
	 * Constructs a be.vliz.emodnet.querytool.core collection builder for the string parameter.
	 * 
	 * @param geoJSON
	...
	/**
	 * Creates a be.vliz.emodnet.querytool.core collection from the attribute "geoJSON".
	 * 
	...
	/**
	 * Creates a be.vliz.emodnet.querytool.core. The parameter should respect a geojson be.vliz.emodnet.querytool.core specs.
	 * 
	 * @param feature
	 *            a map that contains be.vliz.emodnet.querytool.core data
	 * @return {@link Feature}
	 */
	@SuppressWarnings("unchecked")
